                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:left;color:#555;">
                                                {{ Auth::guard('admin')->user()->name }} {{ "<".Auth::guard('admin')->user()->email.">" }} wants to see your business achieve more success and has invited you to better connect with travelers who want amazing trips personalised and tailor-made to their specific requirements and budget using Quovoy.
                                            </div>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                <tbody><tr>
                                                    <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                        <a href="{{ route('dashboard') }}" target="_blank" style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                           Get Started with Quovoy
                                                        <a>
                                                    </td>
                                                </tr>
                                            </tbody></table>
