                        ...
                        <form method="post" action="{{ route('admin.proposals.store') }}" autocomplete="off"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-3">
                                    <div class="card">
                                        <div class="card-header">Proposal Summary</div>
                                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content pt-2" id="borderedTabContent">
                                                <div class="tab-pane fade show active" id="flights" role="tabpanel"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-3">Flight Option 1</div>
                                                        <div class="col-12 col-md-9">
                                                            <div class="row">
                                                                <div class="col-2"> <button type="button"
                                                                        class="btn btn-primary">+</button></div>
                                                                <div class="col-10">
                                                                    Use this option to add more flight options as part of
                                                                    your proposal
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Flight date">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Airline Name">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Flight Number">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Flight from">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Departure Time">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Time zone">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Flight To">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Arrival Time">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Time zone">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Number of Adults">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Seat type">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Max. Hand luggage allowance (per adult)">
                                                                        </div>

                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Max. Haul luggage allowance (per adult)">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Number of Children">
                                                                        </div>
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Seat type">
                                                                        ...
                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Max. Hand luggage allowance (per child)">
                                                                        </div>

                                                                        <div class="col-md-3 px-0">
                                                                            <input type="text" class="form-control"
                                                                                id="inputEmail5" placeholder="Max. Haul luggage allowance (per child)">
                                                                        </div>
                                                                    </div>

                                                                    <div class="row">
                                                                        <div class="col-md-12 px-0">
                                                                            <textarea class="form-control" placeholder="Additional flight information/ disclaimers/ anything else the client must know about any aspects of this flight option" name="" id=""></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5 px-0">
                                                                            <textarea class="form-control" placeholder="Add additional costs client should be aware off. Select if the cost is ‘Optional’ or ‘Required’ Add as many additional costs as necessary." name="" id=""></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5 px-0">
                                                                            <textarea class="form-control" placeholder="Add inclusive costs client should be aware off. These could be a breakdown of costs.included in the ‘Total cost’" name="" id=""></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row py-2">
                                                                        <div class="col-md-3 px-0">
                                                                           <button type="button" class="btn btn-primary">Add another Flight</button>
                                                                        </div>
                                                                        <div class="col-md-9">
                                                                            <p>Use this option to add more fight details especially if clients have connecting flights to complete their journey</p>
                                                                        </div>
                                                                    </div>
